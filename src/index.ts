...
export var api_key: string  // the API key to use, get one at https://studio.oneai.com/settings/api-keys
export var PRINT_PROGRESS = true  // whether to log progress when processing batches
