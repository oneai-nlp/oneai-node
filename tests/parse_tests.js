...
function runTests(inputTests) {
  inputTests.forEach((t, i) => {
    ...
    if (parsed == null || (t.elements > 0) !== (parsed.error == null)) {
      console.log(`Failed input #${i}: ${t.text}`);
    ...
    if ((t.elements > 0) && (parsed.error || parsed.utterances.length !== t.elements)) {
      console.log(`Failed input #2.${i} - ${parsed.error}`);

      console.log('expected elements:');
      console.log(t.elements);
      console.log('actual elements:');
      console.log(parsed.utterances.length);
      console.log('actual output:');
      console.log(parsed);
      console.assert(false);
    }
